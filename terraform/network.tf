...
resource "aws_subnet" "app_subnet_public_0" {
...
resource "aws_route_table_association" "app_route_table_association_public_0" {
  subnet_id      = aws_subnet.app_subnet_public_0.id
  route_table_id = aws_route_table.app_route_table_public.id
}

resource "aws_route_table_association" "app_route_table_association_public_1" {
